...
export class CreatePaymentDto {
  ...
  @ApiProperty({ example: 'MPESA123456', description: 'Transaction ID of the payment' })
  transactionId: string;

  @ApiProperty({ example: 150.75, description: 'Amount paid' })
  amount: number;

  @ApiProperty({ example: '2025-06-10T12:34:56.000Z', description: 'Timestamp when payment was made' })
  paidAt: Date;
