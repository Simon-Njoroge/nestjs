  ...
  public static async stkPush(
    ...
    try {
      ...
      if (message.includes('insufficient balance')) {
        throw new Error(
          'You have insufficient funds. Please top up your M-PESA and try again.',
        );
      }
      if (message.includes('cancelled')) {
        throw new Error(
          'Payment was cancelled. Please try again if this was unintentional.',
        );
      }
